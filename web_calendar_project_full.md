...
## Описание
Този проект представлява система за управление на презентации, която позволява на студенти да се записват за презентации, а на преподаватели да ги одобряват.
...
4. Стартирай XAMPP и отвори:
   - [Вход](http://localhost/project/public/index.php)  
   - [Регистрация](http://localhost/project/public/register.php)  
   - [Календар](http://localhost/project/public/calendar.php)  
   - [Препоръчани презентации](http://localhost/project/public/recommended.php)  
   - [Радар](http://localhost/project/public/radar.php)  
